...
functionChainList_tabName[4] = "Line";
...
functionChainList_scrollRangeMin[4] = 0;
functionChainList_scrollRangeMax[4] = functionChainList_maxScrollRange;
