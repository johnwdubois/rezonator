...
functionChainList_tabRezBrush = 1;
functionChainList_tabTrackBrush = 2;
...
functionChainList_tabName[0] = "Line";
functionChainList_tabName[1] = "Rez";
functionChainList_tabName[2] = "Track";
