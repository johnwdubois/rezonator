...
// View menu
	...
	if(mouse_check_button_released(mb_left) and menuClickedIn){
		...
		ds_list_add(dropDownOptionList, "Increase Text Size", "Decrease Text Size", "Increase Column Size",  "Decrease Column Size","Increase Row Size", "Decrease Row Size", "Toggle Dark Theme", "Toggle Nav Window", "Toggle Audio Window", "Start StackShow");
