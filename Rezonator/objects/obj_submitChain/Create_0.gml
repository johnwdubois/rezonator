...
submitChainRectY1 = 0 + obj_menuBar.menuHeight;
submitChainRectX2 = camera_get_view_width(view_camera[0]) - 105;
submitChainRectY2 = 200 + obj_menuBar.menuHeight;

submitChainButtonX1 = submitChainRectX1 + 10;
submitChainButtonY1 = (submitChainRectY2 / 2) + 20;
submitChainButtonX2 = submitChainRectX2 - 10;
submitChainButtonY2 = submitChainRectY2 - 20;