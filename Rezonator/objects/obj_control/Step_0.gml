...
if (keyboard_check_pressed(ord("P")) and !keyboard_check(vk_control) and (!keyboard_check(vk_lshift) and !keyboard_check(vk_rshift)) and shortcutsEnabled and !mouseoverTagShortcut and currentActiveLineGrid != searchGrid) {
