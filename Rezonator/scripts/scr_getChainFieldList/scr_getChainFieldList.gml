...
function scr_getChainFieldList(chainType) {
	...
	for (var i = 0; i < chainEntryFieldListSize; i++) {
		var currentField = ds_list_find_value(global.chainFieldList, i);
		var currentFieldSubMap = ds_map_find_value(global.chainFieldMap, currentField);
