function scr_unitMarkerOptions(optionSelected) {
	...
	if (optionSelected == "option_create-new-field") {
		...
		var indexOfTranslation = ds_list_find_index(obj_control.panelPaneTabList, NAVTAB_TRANSLATION);
		if (indexOfTranslation < 0) {
			ds_list_insert(obj_control.panelPaneTabList, 2, NAVTAB_TRANSLATION);
		}
	}
