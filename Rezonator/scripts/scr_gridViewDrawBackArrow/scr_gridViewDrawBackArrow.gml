...
function scr_gridViewDrawBackArrow() {
	...
	if(instance_exists(obj_dropDown) || obj_control.currentView == obj_control.mainView) {
		exit;
	}
	...
	if (mouseover) {
		...
		scr_createTooltip(backArrowRectX2, mean(backArrowRectY1, backArrowRectY2), tooltipText, global.arrowFaceLeft);
	}
