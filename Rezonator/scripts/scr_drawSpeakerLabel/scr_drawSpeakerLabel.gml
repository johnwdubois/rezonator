function scr_drawSpeakerLabel(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	/*
		...
		and not instance_exists(obj_dialogueBox)  and not instance_exists(obj_dropDown) and !obj_control.mouseoverPanelPane) {
			...
			if(mouse_check_button_pressed(mb_right)) {
				...
				if (ds_list_size(dropDownOptionList) > 0 and obj_control.ableToCreateDropDown) {
					...
					scr_createDropDown(mouse_x, mouse_y, dropDownOptionList, obj_control.optionListTypeSpeakerLabel);
				}
			}
