function scr_preImportInitiate() {
	...
	for (var i = 0; i < importTypeListSize; i++) {
		...
		// Plain text
		if (importTypeStr == IMPORTTYPE_SONG) {
			...
			// description
			ds_list_add(descriptionList, "• "+ scr_get_translation("import_descrip_song_form"),"• " + scr_get_translation("import_descrip_song_newline"),"• "+ scr_get_translation("import_descrip_song_wordwrap"),"• "+ scr_get_translation("import_descrip_prose_split"),"• "+ scr_get_translation("import_descrip_song_filetype"));
			// links
			ds_list_add(linksList, "https://rezonator.com", "https://genius.com");
		}

		// Paragraph
		else if (importTypeStr == IMPORTTYPE_PROSE) {
		...
		// AI CHAT
		else if (importTypeStr == IMPORTTYPE_AICHAT) {
		...
		// Transcription
		else if (importTypeStr == IMPORTTYPE_TRANSCRIPTION) {
			...
			// description
			ds_list_add(descriptionList, "• " + scr_get_translation("import_descrip_trans_form"),"• " + scr_get_translation("import_descrip_elan_read"),"• " + scr_get_translation("import_descrip_elan_speaker"),"• " + scr_get_translation("import_descrip_trans_timestamps"),"• " + scr_get_translation("import_descrip_prose_split"),"• " + scr_get_translation("import_descrip_trans_filetype"));			
			// links
			ds_list_add(linksList, "https://rezonator.com");
		}
		
		// Tab-delimited (Elan)
		else if (importTypeStr == IMPORTTYPE_ELAN) {
			...
			// description
			ds_list_add(descriptionList, "• " + scr_get_translation("import_descrip_elan_form"),"• " + scr_get_translation("import_descrip_elan_block"),"• " + scr_get_translation("import_descrip_elan_read"),"• " + scr_get_translation("import_descrip_elan_speaker"),"• " + scr_get_translation("import_descrip_elan_timestamps"),"• " + scr_get_translation("import_descrip_elan_whitespace"),"• " + scr_get_translation("import_descrip_elan_filetype"));			
			// links
			ds_list_add(linksList, "https://rezonator.com");
		}
		
		// IGT
		else if (importTypeStr == IMPORTTYPE_IGT) {
			...
			// description
			ds_list_add(descriptionList, "• " + scr_get_translation("import_descrip_elan_form"),"• " + scr_get_translation("import_descrip_igt_lines"),"• " + scr_get_translation("import_descrip_igt_separate"),"• " + scr_get_translation("import_descrip_igt_split"),"• " + scr_get_translation("import_descrip_igt_filetype"));
			// links
			ds_list_add(linksList, "https://scription.digitallinguistics.io/");
		}
		
		// CSV
		else if (importTypeStr == IMPORTTYPE_WORD) {
			...
			// description
			ds_list_add(descriptionList, "• " + scr_get_translation("import_descrip_word_form"),"• " + scr_get_translation("import_descrip_word_newline"),"• " + scr_get_translation("import_descrip_word_row"),"• " + scr_get_translation("import_descrip_conllu_column"),"• " + scr_get_translation("import_descrip_conllu_filetype"));
			// links
			ds_list_add(linksList, "https://rezonator.com");
		}
		
		// CoNLL-U
		else if (importTypeStr == IMPORTTYPE_CONLLU) {
			...
			// description
			ds_list_add(descriptionList, "• " + scr_get_translation("import_descrip_word_form"),"• " + scr_get_translation("import_descrip_word_newline"),"• " + scr_get_translation("import_descrip_conllu_row"),"• " + scr_get_translation("import_descrip_conllu_column"),"• " + scr_get_translation("import_descrip_conllu_hashtag"),"• " + scr_get_translation("import_descrip_song_filetype"));
			// links
	...
	global.preImportGridWidth = 2;
	global.preImportGrid_colChoose = 0;
	global.preImportGrid_colDataType = 1;
	global.preImportGrid = ds_grid_create(global.preImportGridWidth, ds_list_size(global.importTypeList));
	...
	for (var i = 0; i < importTypeListSize; i++) {
		...
		ds_grid_set(global.preImportGrid, global.preImportGrid_colDataType, i, currentDataType);
