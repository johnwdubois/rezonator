...
function scr_preImportInitiate(){
	...
	for (var i = 0; i < importTypeListSize; i++) {
		...
		if (importTypeStr == global.importType_PlainText) {
			...
			// example
			ds_list_add(exampleList, "---","We Shall Overcome","---","We shall overcome,","We shall overcome,","We shall overcome someday.","","Oh, deep in my heart I do believe","We shall overcome someday.","","We'll walk hand in hand,","we'll walk hand in hand,","We'll walk hand in hand someday.","","Oh, deep in my heart I do believe","We shall overcome someday.","","We shall live in peace,","we shall live in peace,","We shall live in peace someday.","","Oh, deep in my heart I do believe","We shall overcome someday.","","We shall brothers be,","we shall brothers be,","We shall brothers be someday.","","Oh, deep in my heart I do believe","We shall overcome someday.","","We shall organize,","we shall organize,","We shall organize today.","","Oh, deep in my heart I do believe","We shall overcome someday.","","The truth shall make us free,","truth shall make us free,","The truth shall make us free someday.","","Oh, deep in my heart I do believe","We shall overcome someday.","","We are not afraid,","we are not afraid,","We are not afraid today.","","Oh, deep in my heart I do believe,","We shall overcome someday.","","We shall overcome,","We shall overcome,","We shall overcome someday.","","Oh, deep in my heart I do believe","We shall overcome someday.");
			// description
