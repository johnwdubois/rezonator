...
function FirebaseREST_HTTP_Success_Firestore()
{
	switch(event)
	{
		...
		case "FirebaseFirestore_Collection_Listener":
			show_debug_message("FirebaseFirestore_Collection_Listener");
	    ...
	    case "FirebaseFirestore_Collection_Query":
			show_debug_message("FirebaseFirestore_Collection_Query");
		...
		case "FirebaseFirestore_Document_Listener":
			show_debug_message("FirebaseFirestore_Document_Listener");
