	...
	switch (optionSelected)
	{
		...
		case "Zoom":
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y + optionSpacing, dropDownOptionList, obj_control.optionListTypeZoom);
			}
		...
		case "Autosave":
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				obj_control.ableToCreateDropDown = false;
				obj_control.alarm[0] = 2;*/
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y + (obj_dropDown.optionSpacing * 5), dropDownOptionList, obj_control.optionListTypeAutosave);
			}
		break;
		case "Advanced":
			scr_destroyAllDropDownsOtherThanSelf();
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				obj_control.ableToCreateDropDown = false;
				obj_control.alarm[0] = 2;*/
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y + (obj_dropDown.optionSpacing * 6), dropDownOptionList, obj_control.optionListTypeAdvanced);
			}
		break
		default:
		break;
