...
while (ds_grid_value_exists(obj_chain.anaphChainGrid, obj_chain.chainGrid_colChainState, 0, obj_chain.chainGrid_colChainState, ds_grid_height(obj_chain.anaphChainGrid), obj_chain.chainStateFocus))
{
	...
	ds_grid_set(obj_chain.anaphChainGrid, obj_chain.chainGrid_colChainState, rowInChainGrid, obj_chain.chainStateNormal);
}
