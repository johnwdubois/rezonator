	...
	switch (optionSelected)
	{
		...
		case "Tag":
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				obj_control.ableToCreateDropDown = false;
				obj_control.alarm[0] = 2;*/
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y+ obj_dropDown.optionSpacing * 4, dropDownOptionList, obj_control.optionListTypeWordTags);
			}
		...
		case "New Word":
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				obj_control.ableToCreateDropDown = false;
				obj_control.alarm[0] = 2;*/
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y + obj_dropDown.optionSpacing, dropDownOptionList, obj_control.optionListTypeNewWord);
			}
