		...
		for (var j = 0; j < tagInfoGridHeight; j++) {
			...
			if (i == global.tagInfoGrid_colMarkerPercent) {
				...
				if (!instance_exists(obj_dropDown) && mouseoverDropDown) {
					scr_createTooltip(mean(dropDownButtonX1, dropDownButtonX2), dropDownButtonY2, scr_get_translation("option_change-level"), global.arrowFaceUp);
				...
				if (drawDropDown) {
					...
					if (!instance_exists(obj_dropDown) && mouseoverDropDown) {
						scr_createTooltip(mean(dropDownButtonX1, dropDownButtonX2), dropDownButtonY2, scr_get_translation("option_change-key"), global.arrowFaceUp);
				...
				if (drawDropDown) {
					...
					if (!instance_exists(obj_dropDown) && mouseoverDropDown) {
						scr_createTooltip(mean(dropDownButtonX1, dropDownButtonX2), dropDownButtonY2, scr_get_translation("option_change-special-field"), global.arrowFaceUp);
