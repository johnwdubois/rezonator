	...
	switch (optionSelected)
	{
		...
		case "Media"://needs filling out
			...
			if (ds_list_size(dropDownOptionList) > 0) {
				...
				scr_createDropDown(obj_dropDown.x + obj_dropDown.windowWidth, obj_dropDown.y + obj_dropDown.optionSpacing, dropDownOptionList, obj_control.optionListTypeClear);
			}
		break;
