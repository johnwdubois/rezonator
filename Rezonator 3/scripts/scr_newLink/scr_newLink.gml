...
if (ds_grid_value_exists(obj_chain.linkGrid, obj_chain.linkGrid_colFocus, 0, obj_chain.linkGrid_colFocus, ds_grid_height(obj_chain.linkGrid), true))
{
	...
	{
		ds_grid_set(obj_chain.linkGrid, obj_chain.linkGrid_colGoal, focusedRow, wordID);
	}
}
...
ds_grid_set(obj_chain.linkGrid, obj_chain.linkGrid_colSource, currentLinkGridRow, wordID);
